...
<template>
  <div class="flex flex-wrap items-center justify-end gap-3 pt-3 text-sm text-muted">
    ...
    <div class="flex items-center gap-1">
      <button class="flex h-7 w-7 items-center justify-center rounded-chrome border border-line bg-surface text-muted transition-colors hover:border-primary hover:text-primary disabled:cursor-not-allowed disabled:opacity-40" :disabled="page <= 1" @click="go(page - 1)">
      ...
      <button class="flex h-7 w-7 items-center justify-center rounded-chrome border border-line bg-surface text-muted transition-colors hover:border-primary hover:text-primary disabled:cursor-not-allowed disabled:opacity-40" :disabled="page >= pages" @click="go(page + 1)">
